...
(global.Tokito = {
  get config() {
    try {
      return JSON.parse(
        fs.readFileSync(path.join(__dirname, "botdata.json"), "utf-8")
      );
    } catch (error) {
      // @ts-ignore
  ...
  Object.assign(global.Tokito, {
    ...
    get antitheft() {
      return global.Tokito.config.antitheft;
    },
    get developers() {
    ...
    get moderator() {
      return global.Tokito.config.moderators;
    },
    get webDevs() {
      return global.Tokito.config.webDevs;
    },
    get webAdmns() {
      return global.Tokito.config.webAdmns;
    },
    get webMods() {
      return global.Tokito.config.webMods;
    },
  });
